...
| ID | Year | Venue |   Abbr   |  Title   |   PDF   |  Code  |
|:--:|:----:|:-----:|:--------:|:--------:|:-------:|:------:|
| 1 | 2021 | ICRA | FGR | Fgr: Frustum-aware geometric reasoning for weakly supervised 3d vehicle detection | [![PDF](https://img.shields.io/badge/PDF-View-red?style=plastic)](Fgr: Frustum-aware geometric reasoning for weakly supervised 3d vehicle detection) | [![GitHub stars](https://img.shields.io/github/stars/weiyithu/FGR)](https://github.com/weiyithu/FGR) 
| 2 | 2022 | ICPR | Map-gen | Map-gen: An automated 3d-box annotation flow with multimodal attention point generator | [![PDF](https://img.shields.io/badge/PDF-View-red?style=plastic)]() | [![GitHub stars](-)](-) 
...
| 7 | 2023 | TPAMI | VEL | Vectorized Evidential Learning for Weakly-supervised Temporal Action Localization | [![PDF](https://img.shields.io/badge/PDF-View-red?style=plastic)](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10238828) | [![GitHub stars](-)](-) 
...
| 4 | 2022 | OpenReview | - | Modeling Unknown Semantic Labels as Uncertainty in the Prediction: Evidential Deep Learning for Class-Incremental Semantic Segmentation | [![PDF](https://img.shields.io/badge/PDF-View-red?style=plastic)](https://openreview.net/pdf?id=-BBL3b4Tqfo) | [![GitHub stars](-)](-)
| 5 | 2022 | arXiv | BEL | Bayesian evidential learning for few-shot classification | [![PDF](https://img.shields.io/badge/PDF-View-red?style=plastic)](https://arxiv.org/pdf/2207.13137) | [![GitHub stars](-)](-) 
| 6 | 2022 | AAAI | TNT | Evidential neighborhood contrastive learning for universal domain adaptation | [![PDF](https://img.shields.io/badge/PDF-View-red?style=plastic)](https://ojs.aaai.org/index.php/AAAI/article/download/20575/20334) | [![GitHub stars](-)](-) 
...
| 10 | 2024 | OpenReview | BKD | Bayesian Knowledge Distillation for Online Action Detection | [![PDF](https://img.shields.io/badge/PDF-View-red?style=plastic)](https://openreview.net/pdf?id=8iojQVLLWb) | [![GitHub stars](-)](-) 
| 11 | 2024 | arXiv | UGA | Uncertainty-Guided Alignment for Unsupervised Domain Adaptation in Regression | [![PDF](https://img.shields.io/badge/PDF-View-red?style=plastic)](https://arxiv.org/pdf/2401.13721) | [![GitHub stars](-)](-) 
